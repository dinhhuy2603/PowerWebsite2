...
var dataColors;
colors = ["#f1556c"];
(dataColors = $("#apex-radialbar-3, #apex-radialbar-4, #apex-radialbar-5, #apex-radialbar-6").data("colors")) && (colors = dataColors.split(","));
var chart;
options = {
    chart: {
        height: 250,
...
(chart = new ApexCharts(document.querySelector("#apex-radialbar-4"), options)).render();
(chart = new ApexCharts(document.querySelector("#apex-radialbar-5"), options)).render();
(chart = new ApexCharts(document.querySelector("#apex-radialbar-6"), options)).render();